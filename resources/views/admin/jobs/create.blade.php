        ...
        <form action="{{ route('admin.jobs.store') }}" method="POST">
            ...
            <div class="p-6 sm:p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="5" class="mt-1 block w-full border-gray-300 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm" required placeholder="Describe the role and responsibilities...">{{ old('description') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="requirements" name="requirements" rows="5" class="mt-1 block w-full border-gray-300 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm" placeholder="List the necessary skills and qualifications...">{{ old('requirements') }}</textarea>
                ...
                <div class="block mt-4">
                    <label for="is_archived" class="inline-flex items-center">
                        <input id="is_archived" type="checkbox" class="rounded border-gray-300 text-[#E07B2A] shadow-sm focus:ring-[#E07B2A]" name="is_archived" value="1" {{ old('is_archived') ? 'checked' : '' }}>
