    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Manage and assign project estimation requests.</p>
            </div>
            <div>
                ...
                <table class="min-w-full divide-y divide-gray-100">
                    <thead class="bg-gray-50/80">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Client Details</th>
                            <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Project Needs</th>
                            <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Assignment</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-50">
                        @forelse($quotations as $quote)
                            <tr class="hover:bg-gray-50/50 transition-colors duration-150 group {{ $quote->status === 'Pending' ? 'bg-orange-50/30' : '' }}">
                                <td class="px-6 py-4 whitespace-nowrap w-10">
                                    <input type="checkbox" name="ids[]" value="{{ $quote->id }}" class="select-item rounded border-gray-300 text-[#E07B2A] focus:ring-[#E07B2A]">
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-4">
                                        <a href="{{ route('admin.quotations.show', $quote) }}" class="inline-flex items-center text-[#E07B2A] hover:text-orange-700">
