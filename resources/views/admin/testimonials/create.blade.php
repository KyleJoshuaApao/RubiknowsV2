        ...
        <form action="{{ route('admin.testimonials.store') }}" method="POST">
            ...
            <div class="p-6 sm:p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="quote" name="quote" rows="4" class="block w-full bg-gray-50 border-0 border-b-4 border-gray-200 focus:border-brand-500 focus:ring-0 px-4 py-4 font-bold text-gray-900 transition-colors" required>{{ old('quote') }}</textarea>
                ...
                <div class="block mt-4">
                    <label for="is_published" class="inline-flex items-center">
                        <input id="is_published" type="checkbox" class="rounded border-gray-300 text-brand-500 shadow-sm focus:ring-[#E07B2A]" name="is_published" value="1" {{ old('is_published', true) ? 'checked' : '' }}>
