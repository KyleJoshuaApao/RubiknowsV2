        ...
        <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST">
            ...
            <div class="p-6 sm:p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="quote" name="quote" rows="4" class="mt-1 block w-full border-gray-300 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm" required>{{ old('quote', $testimonial->quote) }}</textarea>
                ...
                <div class="block mt-4">
                    <label for="is_published" class="inline-flex items-center">
                        <input id="is_published" type="checkbox" class="rounded border-gray-300 text-[#E07B2A] shadow-sm focus:ring-[#E07B2A]" name="is_published" value="1" {{ old('is_published', $testimonial->is_published) ? 'checked' : '' }}>
