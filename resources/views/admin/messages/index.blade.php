    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm font-bold uppercase tracking-widest text-gray-500 mt-2">Manage inquiries submitted from the contact form.</p>
            </div>
            <div>
                ...
                <table class="min-w-full divide-y divide-gray-100">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-8 py-5 text-left text-xs font-black text-richblack-900 uppercase tracking-widest border-b border-gray-200">Sender</th>
                            <th scope="col" class="px-8 py-5 text-left text-xs font-black text-richblack-900 uppercase tracking-widest border-b border-gray-200">Subject</th>
                            ...
                            <th scope="col" class="px-8 py-5 text-left text-xs font-black text-richblack-900 uppercase tracking-widest border-b border-gray-200">Date</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-50">
                        @forelse($messages as $msg)
                            <tr class="hover:bg-gray-50 transition-colors duration-150 group {{ $msg->status === 'New' ? 'bg-brand-50/30' : '' }}">
                                <td class="px-8 py-6 whitespace-nowrap w-10">
                                    <input type="checkbox" name="ids[]" value="{{ $msg->id }}" class="select-item rounded border-gray-300 text-brand-500 focus:ring-[#E07B2A]">
                                </td>
                                <td class="px-8 py-6 whitespace-nowrap">
                                    <div class="text-base font-black text-richblack-900 uppercase tracking-widest">{{ $msg->name }}</div>
                                ...
                                <td class="px-8 py-6 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-4">
                                        <a href="{{ route('admin.messages.show', $msg) }}" class="inline-flex items-center text-brand-500 hover:text-orange-700">
