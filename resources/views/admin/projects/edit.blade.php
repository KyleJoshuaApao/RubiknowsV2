                    ...
                    <div class="mb-6 border border-gray-200 bg-gray-50 p-5">
                        <div class="flex items-start justify-between gap-4 mb-4">
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Click the Philippine map to place or update this project location.</p>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="number" step="0.0000001" min="4" max="22" name="latitude" id="latitude" value="{{ old('latitude', $project->latitude) }}" class="form-input-v2" placeholder="14.5995">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.0000001" min="116" max="128" name="longitude" id="longitude" value="{{ old('longitude', $project->longitude) }}" class="form-input-v2" placeholder="120.9842">
