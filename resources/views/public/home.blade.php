        ...
        <div class="max-w-screen-2xl mx-auto px-6 lg:px-12 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
                ...
                <div x-data x-intersect.once="$el.classList.add('animate-fade-in-up')"
                    ...
                    <svg class="w-10 h-10 text-black/20 mb-6" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/></svg>
        ...
        <div class="w-full lg:w-1/2 p-12 lg:p-24 lg:pl-16 bg-black text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <h4 class="text-white font-bold tracking-wide text-xs mb-3">Headquarters</h4>
                        <p class="text-white font-medium">100 Engineering Plaza<br>Suite 400<br>Metropolis, NY 10001</p>
                    </div>
                    <div>
                        <h4 class="text-white font-bold tracking-wide text-xs mb-3">Regional Offices</h4>
