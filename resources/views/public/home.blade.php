<x-public-layout>
    ...
    <div x-data="homeLivePreview" class="rk-home">
        <section class="relative min-h-[calc(100vh-7rem)] overflow-hidden bg-[#0b0c0c] text-white">
            <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=2200&auto=format&fit=crop" alt="RubiKnows engineering and construction project" fetchpriority="high" class="absolute inset-0 h-full w-full object-cover opacity-45 grayscale">
            ...
            <div class="relative z-10 mx-auto flex min-h-[calc(100vh-7rem)] max-w-[96rem] items-end px-6 pb-16 pt-28 sm:px-10 lg:px-16 lg:pb-24">
                <div class="max-w-5xl">
                    ...
                    <h1 class="max-w-5xl text-6xl font-black uppercase leading-[.82] tracking-[-.07em] sm:text-8xl lg:text-[clamp(5rem,11vw,11rem)]">Building<br><span class="text-[#dcae32]">what lasts.</span></h1>
        ...
        <section class="bg-[#dcae32] px-6 py-14 text-[#0b0c0c] sm:px-10 lg:px-16">
        ...
        <section class="bg-[#0b0c0c] px-6 py-20 text-white sm:px-10 lg:px-16 lg:py-32">
        ...
        <section class="bg-[#f1f0ec] px-6 py-20 text-[#0b0c0c] sm:px-10 lg:px-16 lg:py-32">
            <div class="mx-auto max-w-[96rem]">
    ...
    @push('head')<style>
        ...
        .rk-home .rk-button:hover { transform:translateY(-3px); background:#fff; } .rk-home .rk-button-dark { background:#0b0c0c; color:#fff; } .rk-home .rk-text-link { color:inherit; font-size:.68rem; font-weight:900; letter-spacing:.16em; text-transform:uppercase; } .rk-home .rk-text-link:hover { color:#b18716; }
    </style>@endpush
    @push('scripts')<script>
