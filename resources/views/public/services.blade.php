                       ...
                       style="animation-delay: {{ ($loop->index % 3) * 0.05 }}s">
                        ...
                        @if($service->image_path)
                            <div class="aspect-[4/3] w-full overflow-hidden border-b-4 border-richblack-900">
                                <img loading="lazy" src="{{ Storage::disk('public')->url($service->image_path) }}" alt="{{ $service->title }}"
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center mt-4">
                                @if($testimonial->image_path)
                                    <img loading="lazy" src="{{ Storage::disk('public')->url($testimonial->image_path) }}" alt="{{ $testimonial->name }}" class="w-12 h-12 rounded-full object-cover mr-3">
                                @else
