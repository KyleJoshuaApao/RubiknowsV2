            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-7">
                @forelse($media as $item)
                    ...
                    <div x-data x-intersect.once="$el.classList.add('animate-scale-in')"
                         class=" group relative aspect-square bg-white border border-gray-100 rounded-[1.5rem] overflow-hidden cursor-pointer hover:border-orange-200 hover:shadow-2xl hover:shadow-orange-500/10 hover:-translate-y-1 transition-all duration-700"
