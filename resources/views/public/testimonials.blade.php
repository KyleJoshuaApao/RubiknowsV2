                    ...
                    <div x-data x-intersect.once="$el.classList.add('animate-fade-in-up')"
                        ...
                        <div class="flex items-center pt-8 border-t-2 border-gray-100 mt-auto">
                            @if($testimonial->avatar_path)
                                <img loading="lazy" class="h-16 w-16 object-cover mr-6 border-b-4 border-brand-500" src="{{ \App\Support\MediaUrl::for($testimonial->avatar_path) }}" alt="{{ $testimonial->client_name }}">
                            @else
