        ...
        <div>
            ...
            <div class="mt-2 flex items-center space-x-5">
                ...
                <input type="file" id="profile_photo" name="profile_photo" accept="image/*"
                       class="block text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#E07B2A]/10 file:text-[#E07B2A] hover:file:bg-[#E07B2A]/20 transition-all cursor-pointer">
            </div>
