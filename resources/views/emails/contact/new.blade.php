...
<head>
    ...
    <title>New General Inquiry - RubiKnows</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 650px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding: 40px 40px 20px; background-color: #ffffff;">
                            <h1 style="margin: 0 0 10px 0; color: #18181b; font-size: 24px; font-weight: 800; letter-spacing: -0.5px;">New Contact Inquiry</h1>
                            <p style="margin: 0; color: #52525b; font-size: 16px; line-height: 1.6;">
                                A new message was submitted via the contact form on the public website.
                            </p>
                        </td>
                    </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #fafafa; border: 1px solid #e4e4e7; border-radius: 6px;">
                                <tr>
                                    <td width="50%" valign="top" style="padding: 25px; border-right: 1px solid #e4e4e7; border-bottom: 1px solid #e4e4e7;">
                                        <div style="font-size: 11px; font-weight: 700; color: #71717a; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 6px;">Contact Name</div>
                                        <div style="font-size: 16px; font-weight: 600; color: #18181b;">{{ $messageData->name }}</div>
                                    </td>
                                    <td width="50%" valign="top" style="padding: 25px; border-bottom: 1px solid #e4e4e7;">
                                        ...
                                        <div style="font-size: 16px; font-weight: 600; color: #18181b;">{{ $messageData->company ?: 'N/A' }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%" valign="top" style="padding: 25px; border-right: 1px solid #e4e4e7;">
                                        ...
                                        <div style="font-size: 15px; font-weight: 500;">
                                            <a href="mailto:{{ $messageData->email }}" style="color: #E07B2A; text-decoration: none;">{{ $messageData->email }}</a>
                                        </div>
                                    </td>
                                    <td width="50%" valign="top" style="padding: 25px;">
                                        ...
                                        <div style="font-size: 15px; font-weight: 500; color: #18181b;">{{ $messageData->phone ?: 'N/A' }}</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 40px 30px; background-color: #ffffff;">
                            <div style="font-size: 11px; font-weight: 700; color: #71717a; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 12px;">Subject</div>
                            <div style="font-size: 18px; font-weight: 600; color: #18181b; margin-bottom: 20px;">{{ $messageData->subject }}</div>

                            <div style="font-size: 11px; font-weight: 700; color: #71717a; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 12px;">Message</div>
                    ...
                    <tr>
                        <td align="center" style="padding: 10px 40px 50px; background-color: #ffffff;">
                            <a href="{{ url('/admin/messages/' . $messageData->id) }}" style="display: inline-block; background-color: #18181b; color: #ffffff; font-size: 14px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; text-decoration: none; padding: 18px 40px; border-radius: 4px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 30px 40px; background-color: #18181b; text-align: center;">
                            ...
                            <p style="margin: 0; font-size: 12px; color: #71717a;">
                                This is an automated notification from the RubiKnows communications system.<br>
