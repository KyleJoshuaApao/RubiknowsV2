...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-richblack-900 bg-white flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-richblack-950 flex-shrink-0 flex flex-col hidden md:flex text-gray-300 relative z-20">
            ...
            <!-- Branding -->
            <div class="h-20 flex items-center px-6 bg-richblack-950 relative z-10 border-b-4 border-brand-500 kh-angled-bottom-right">
            ...
            <div id="rk-confirm-box"
                ...
                <div class="px-7 pt-7 pb-6">
                    ...
                    <div class="flex items-center gap-4 mb-5">
                        ...
                        <div>
                            <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-brand-500 mb-0.5">Confirm Action</p>
        ...
        (function () {
            ...
            function rkToast(message, type) {
                ...
                var cfg = {
                    ...
                    error   : { icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/>', bar: '#E31B23', iconColor: '#E31B23', bg: '#fff' },
