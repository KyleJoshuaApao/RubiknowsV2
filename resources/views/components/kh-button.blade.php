...
<a href="{{ $href }}" {{ $attributes->merge(['class' => 'group inline-flex items-stretch font-bold text-sm tracking-wide text-charcoal-700 transition-all duration-200 hover:-translate-y-0.5']) }}>
    ...
    <div class="bg-brand-500 text-richblack-900 px-4 py-3 flex items-center justify-center kh-angled-arrow-block group-hover:bg-brand-600 transition-colors duration-200 -ml-[15px] relative z-10">
