...
## Corpus Check
- 292 files · ~1,404,347 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1347 nodes · 1535 edges · 246 communities (204 shown, 42 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cb612862`
...
## Communities (246 total, 42 thin omitted)
